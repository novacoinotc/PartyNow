...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-pink-500 to-violet-500 text-white shadow-lg hover:from-pink-600 hover:to-violet-600",
        secondary:
          "bg-zinc-800 text-white hover:bg-zinc-700",
        outline:
          "border-2 border-zinc-700 bg-transparent hover:bg-zinc-800 text-white",
        ghost:
          "hover:bg-zinc-800 text-zinc-300",
        link:
          "text-pink-400 underline-offset-4 hover:underline",
        danger:
